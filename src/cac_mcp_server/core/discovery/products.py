...
from cac_mcp_server.core.integration import get_content_repository, get_ssg_modules
from cac_mcp_server.models import ProductDetails, ProductStats, ProductSummary
