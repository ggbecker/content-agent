"""Main entry point for cac-content-mcp-server."""
...
from cac_mcp_server.server import run_stdio_server
...
@click.version_option(version="0.1.0", prog_name="cac-content-mcp-server")
def main(
    ...
    Examples:
      ...
      $ cac-mcp-server --config config.yaml

      # Debug mode
      $ cac-mcp-server --log-level DEBUG
    """
    try:
        # Initialize settings
        ...
        logger.info("Starting cac-content-mcp-server v0.1.0")
